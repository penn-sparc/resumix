...
from resumix.components.modern_ui import ModernUI, modern_header, modern_card, modern_alert
...
def setup_modern_page(page_title="Resumix", page_icon="📄", layout: Literal["centered", "wide"] = "wide"):
